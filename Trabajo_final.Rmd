...
En el *Gráfico 2* podemos observar como queda la relación entre Inputs y Outputs una vez quitados los outliers.
...
Para probar el supuesto de rendimientos constantes a escala se realiza un modelo lineal MCO sobre del output sobre los inputs y se testea la hipótesis nula de que la suma de los coeficientes es igual a 1.  
...
No se rechaza la hipótesis nula de rendimientos constantes a escala, por lo que trabajaremos con este supuesto como es habitual en la literatura de productividad industrial.
