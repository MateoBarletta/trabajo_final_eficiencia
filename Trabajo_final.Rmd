...
Para probar el supuesto de rendimientos constantes a escala se realiza un modelo lineal MCO sobre del output sobre los inputs y se testea la hipótesis nula de que la suma de los coeficientes es igual a 1. Se consideran los valores en logaritmos:
...
No se rechaza la hipótesis nula de rendimientos constantes a escala, por lo que trabajaremos con este supesto como es habitual en la literatura de productividad industrial.
